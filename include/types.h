...
#define GX_RGB(r, g, b) ((u16)(((r) << GX_RGB_R_SHIFT) | ((g) << GX_RGB_G_SHIFT) | ((b) << GX_RGB_B_SHIFT)))
...
#define debug_printf(...)                                         \
    {                                                             \
        sprintf(DebugTextBuf, __VA_ARGS__);                       \
        *(volatile u32 *)NOCASHGBAPRINTADDR1 = (u32)DebugTextBuf; \
    }
#else
#define debug_printf(...)                             \
    {                                                 \
        u8 buf_assumeunuasedfasdf[128];               \
        sprintf(buf_assumeunuasedfasdf, __VA_ARGS__); \
...
void LONG_CALL NARC_ReadWholeMember(void *narc, u32 file_id, void *dest);
u32 LONG_CALL NARC_GetMemberSize(void *narc, u32 file_id);
